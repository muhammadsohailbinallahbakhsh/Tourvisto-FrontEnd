...
import type { BaseTripType } from '@/types';

interface DestinationRelatedTripsProps {
  destinationName: string;
  tripDestinationsData: BaseTripType[];
}

const DestinationRelatedTrips = ({
  tripDestinationsData,
  destinationName,
}: DestinationRelatedTripsProps) => {
  ...
  return (
    <section>
      <h2 className='p-36-bold mb-4'>Trips in {destinationName}</h2>
      <div className='mb-3'>
...
export default DestinationRelatedTrips;
